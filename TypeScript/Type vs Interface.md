...
4. **Псевдонимы типов не поддерживают наследования.** Оно возможно только с интерфейсами. Типы **поддерживают** наследование, но через синтаксис пересечения (`&`), а не через `extends`.
