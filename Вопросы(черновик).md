...
transform,opacity - как влияют на производительность
...
call/apply/bind
Math.random
отличие атрибутов async/defer
кликджекинг, men-in-the-middle/content security policy
...
ContextApi паттерн ServiceLocator (антипаттерн, в солид - д)
